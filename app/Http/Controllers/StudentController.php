...
class StudentController extends Controller
{
    ...
    public function studentUpdate(Request $request)
    {
        ...
        try {
            ...
            if (!empty($request->upload) && $request->has('image_hidden')) {
                $imagePath = storage_path('app/public/student-photos/' . $request->image_hidden);
            ...
            Toastr::error('Failed to update student record: ' . $e->getMessage(), 'Error');
            return redirect()->back();
        }
    }
