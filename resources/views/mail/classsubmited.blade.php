        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 10px; padding-bottom: 40px;" width="596">
              ...
              <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Class Submited</h1>

<div class="class-info">
    <p>New Class Submitted by {{$course->teacher->first_name}} {{$course->teacher->last_name}} of course {{$course->name}} took place at {{\Carbon\Carbon::parse($classSession->date)->format('F j, Y') }}</p>
    <br>
    <p>Report : {{$class->report}}</p>
</div>            
