            ...
            <div>
                ...
                <div class="col-12">
                                        <div class="student-submit">
                                                                   <a href="{{ route('download.invoice.t.pdf', ['teacherId' =>auth()->user()->id,"date"=>$selectedMonth]) }}" class="btn btn-success" style="color: white;"><i class="fas fa-download"></i> Download invoice</a>
@error('download')
