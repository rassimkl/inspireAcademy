                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="{{ route('user/add/page', ['user_type_id' => 1]) }}" class="btn btn-primary">Add Admin <i class="fas fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-auto">
            <label class="my-1" for="perPage">entries</label>
                ...
                <div id="total-count" class="text-muted">Total: {{ $admins->total() }} entries</div>
                <nav>
                    {{ $admins->links() }}
                </nav>
            </div>
