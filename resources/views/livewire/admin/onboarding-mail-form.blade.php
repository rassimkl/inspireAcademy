    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <button wire:click="previewProgrammePdf" class="btn btn-light btn-sm me-2">
                    📄 Prévisualiser le PDF Programme
                </button>

                <button wire:click="previewConventionPdf" class="btn btn-light btn-sm">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control @error('dossierCpf') is-invalid @enderror"
                           wire:model="dossierCpf">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date"
                           class="form-control @error('dateDu') is-invalid @enderror"
                           wire:model="dateDu">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date"
                           class="form-control @error('dateAu') is-invalid @enderror"
                           wire:model="dateAu">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control @error('duree') is-invalid @enderror"
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control @error('lieu') is-invalid @enderror"
                           wire:model="lieu">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('modalite') is-invalid @enderror"
                            wire:model="modalite">
        ...
        ========================== --}}
        <div class="card mb-4">
            <div class="card-header fw-semibold">Texte en plus</div>
            <div class="card-body row g-3">

                <div class="col-md-6">
                    <label class="form-label">Paragraphe 1</label>
                    <textarea class="form-control" wire:model.live="text"></textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Paragraphe 2</label>
                    <textarea class="form-control" wire:model.live="textp2"></textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Paragraphe 3</label>
                    <textarea class="form-control" wire:model.live="textp3"></textarea>
                </div>
